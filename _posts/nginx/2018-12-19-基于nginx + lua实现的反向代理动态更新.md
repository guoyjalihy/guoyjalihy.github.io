---
layout: post
title:  "基于nginx+lua实现的反向代理动态更新"
date:   2018-12-19 20:01:01 +0800
categories: nginx
---

###  环境准备
nginx是当前应用非常广泛的web服务器，但是原生nginx无法实现动态的弹性扩缩容，只能手动改配置文件后reload.  
...
```
如未安装，请先参考 [安装nginx-lua](2018-12-18-安装nginx-lua.md)进行安装
...
<figure>
    <img src="{{ site.baseurl }}/images/nginx-lua-demo.jpg" alt="image">
    <figcaption>
        nginx-lua-demo
    </figcaption>
</figure>
...
<figure>
    <img src="{{ site.baseurl }}/images/nginx-lua-demo-config.jpg" alt="image">
    <figcaption>
        nginx-lua-demo-config
    </figcaption>
</figure>
...
<figure>
    <img src="{{ site.baseurl }}/images/nginx-lua-demo-stop.jpg" alt="image">
    <figcaption>
        nginx-lua-demo-stop
    </figcaption>
</figure>
...
<figure>
    <img src="{{ site.baseurl }}/images/nginx-lua-demo-stop2.jpg" alt="image">
    <figcaption>
        nginx-lua-demo-stop2
    </figcaption>
</figure>
...
<figure>
    <img src="{{ site.baseurl }}/images/nginx-lua-demo-config2.jpg" alt="image">
    <figcaption>
        nginx-lua-demo-config2
    </figcaption>
</figure>
